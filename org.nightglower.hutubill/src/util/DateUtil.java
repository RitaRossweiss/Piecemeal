...
public class DateUtil {
    ...
    //把 java.util.Date 的日期类型转换为 java.sql.Date 的日期类型。
    ...
    /**
     * 获取今天的日期，并且把时，分，秒和毫秒都置0. 因为通过日期控件获取到的日期，都是没有时分秒和毫秒的。
     * @return
     */
     ...
     * 在统计消费一览信息的时候，查看本月的消费数据，其实就是从数据库中去把从本月第一天到最后一天的数据查出来，再进行简单统计。
     * 所以需要一个获取本月第一天的方法。
     * @return
     */
